...
import provider
import tf_util
import part_pheno4d_unlabelled_normal
...
TEST_DATASET = part_pheno4d_unlabelled_normal.PartNormalDataset(npoints=NUM_POINT, classification=False, split='test', category=CATEGORY)
