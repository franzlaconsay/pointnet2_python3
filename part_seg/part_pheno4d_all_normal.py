...
class PartNormalDataset():
    def __init__(self, root = '../data/pheno4d_all', npoints = 2500, classification = False, split='train', normalize=True, return_cls_label = False, train_sample = 1, category='maize_tomato'):
